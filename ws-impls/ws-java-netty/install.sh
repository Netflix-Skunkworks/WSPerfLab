...
eval "$sshCommand $hostname 'cp WSPerfLab/ws-impls/ws-java-servlet-blocking/build/libs/ws-java-servlet-blocking-*-SNAPSHOT.war apache-tomcat-7.0.37/webapps/ws-java-servlet-blocking.war'"
echo "--- Start Tomcat 7"
